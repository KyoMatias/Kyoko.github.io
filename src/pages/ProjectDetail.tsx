...
const projectsData: Record<string, ProjectData> = {
  ...
  todapay: {
    ...
    description: 'A startup application that focuses on digitalizing tricycle booking, bringing modern transportation solutions to traditional commuting methods.',
    image: imgImage3,
    details: {
